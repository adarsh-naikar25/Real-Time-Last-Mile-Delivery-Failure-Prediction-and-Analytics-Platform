...
The Real Time Last Mile Delivery Failure Prediction and Analytics Platform is an advanced Machine Learning based system developed to predict delivery failures and provide intelligent real-time analytics for last mile delivery operations.
...
*  Delivery Route Visualization using Interactive Maps
...
3. Prediction probability is calculated
4. Results are stored in MySQL database
5. Interactive analytics are displayed
6. Delivery route visualization is generated
7. Reports are exported in PDF format
